 ...
 *   - `logger` (optional): The logger instance to use for request logging.
 *
...
export const createIgniterRouter = <
  ...
  TPlugins extends Record<
    string,
    IgniterPlugin<any, any, any, any, any, any, any, any>
  > = {},
...
>({
  ...
  return {
     ...
     * const result = await router.caller.users.getUserById({ id: "123" });
     */
    caller: createServerCaller(controllers, processor) as TRouter["caller"],
