...
import { IgniterTelemetryRedaction } from './redaction'
import type { TelemetryEnvelope } from '../types/envelope'

describe('IgniterTelemetryRedaction', () => {
  describe('createRedactor()', () => {
    it('should return attributes unchanged with empty policy', async () => {
      const redactor = IgniterTelemetryRedaction.createRedactor({})
  ...
  describe('createSyncRedactor()', () => {
    it('should work synchronously', () => {
      const redactor = IgniterTelemetryRedaction.createSyncRedactor({
        denylistKeys: ['password'],
      })
  ...
  describe('redactEnvelope()', () => {
    it('should redact attributes in an envelope', async () => {
      ...
      const redacted = await IgniterTelemetryRedaction.redactEnvelope(envelope, {
        denylistKeys: ['password'],
      })
