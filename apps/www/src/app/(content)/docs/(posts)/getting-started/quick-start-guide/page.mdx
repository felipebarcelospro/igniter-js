...
*   **[Core Concepts](/docs/core-concepts/the-igniter-builder)**: Learn about the fundamental building blocks of Igniter.js in detail.
*   **[Installation](/docs/getting-started/installation)**: Detailed installation instructions and options.
*   **[Project Structure](/docs/getting-started/project-structure)**: Best practices for organizing your Igniter.js projects.