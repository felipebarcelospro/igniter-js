...
This command sets up everything you need, including the core library, folder structure, and basic configuration files. For a full walkthrough, please see our **[Quick Start Guide](/docs/getting-started/quick-start-guide)**.
...
Once you have Igniter.js installed, you're ready to start building! Here are some recommended next steps:

- **[Quick Start Guide](/docs/getting-started/quick-start-guide)** - Build your first API endpoint
- **[Project Structure](/docs/getting-started/project-structure)** - Learn about recommended project organization
- **[Core Concepts](/docs/core-concepts/the-igniter-builder)** - Understand the fundamental building blocks