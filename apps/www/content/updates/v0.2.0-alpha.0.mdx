...
- `@igniter-js/adapter-redis` - Redis adapter for caching and pub/sub
- `@igniter-js/adapter-bullmq` - BullMQ adapter for background jobs
- `@igniter-js/adapter-opentelemetry` - OpenTelemetry adapter for telemetry
- `@igniter-js/adapter-mcp-server` - MCP Server adapter for AI integrations
...
npm install @igniter-js/adapter-mcp-server
```
