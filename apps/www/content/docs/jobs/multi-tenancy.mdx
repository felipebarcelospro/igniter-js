---
title: Multi-Tenancy
description: Build multi-tenant applications with queue prefixes, isolated job processing, and tenant-specific configurations.
---
...
queue: { prefix: `tenant-${tenantId}` }

// ❌ Bad - inconsistent patterns
queue: { prefix: `t-${tenantId}` }
queue: { prefix: `${tenantId}-queue` }
```
