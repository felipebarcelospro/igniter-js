...
For AI models that don't support MCP, Igniter.js exposes an `llms.txt` file—a machine-readable documentation format that helps AI understand your API structure and how to interact with it.

View it at [https://igniterjs.com/llms.txt](https://igniterjs.com/llms.txt).