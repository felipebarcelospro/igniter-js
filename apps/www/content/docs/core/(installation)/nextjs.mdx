---
title: Next.js
description: Build full-stack, type-safe applications with Igniter.js and Next.js App Router.
---
...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']} groupId="package-manager">
  <Tab value="npm">
    ```bash
    npx create-igniter-app@latest my-app --template nextjs
    cd my-app
    npm install
    npm run dev
    ```
  ...
  <Tab value="pnpm">
    ```bash
    pnpm create igniter-app my-app --template nextjs
    cd my-app
    pnpm install
    pnpm dev
    ```
  ...
  <Tab value="yarn">
    ```bash
    yarn create igniter-app my-app --template nextjs
    cd my-app
    yarn install
    yarn dev
    ```
  ...
  <Tab value="bun">
    ```bash
    bunx create-igniter-app my-app --template nextjs
    cd my-app
    bun install
    bun dev
    ```
...
Follow this guide to add Igniter.js to an existing Next.js project or understand how everything works.
...
<Tabs items={['npm', 'pnpm', 'yarn', 'bun']} groupId="package-manager">
  ...
  <Tab value="pnpm">
    ```bash
    pnpm add -D @igniter-js/cli
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn add -D @igniter-js/cli
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bun add -D @igniter-js/cli
    ```
  </Tab>
</Tabs>
...
Run the CLI to generate `igniter.schema.ts` and OpenAPI documentation:

```bash
npx igniter-cli generate
```
