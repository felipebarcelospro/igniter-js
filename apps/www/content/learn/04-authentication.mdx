...
<Quiz
  question="Why do we inject PasswordService and JwtService into igniter.context.ts?"
  options={[
    ...
    { label: 'It is required by Igniter.js', value: 'required' }
  ]}
...
<ChapterNav
  ...
  next={{
    ...
    description: 'Connect your frontend using the auto-generated Igniter.js client with full type safety and built-in React hooks.',
