...
**File:** `.cursor/rules/api-validation-workflow.mdc`  
**When to read:** When implementing or testing API endpoints  
**Why:** Ensures comprehensive API testing and validation throughout development  
**Key areas:** OpenAPI spec integration, HTTP request testing, mandatory validation patterns, delegation integration
...
**When to read:** When creating or modifying API endpoints  
**Why:** Detailed reference for building controllers, actions, and validation layers  
**Key areas:** Controller definitions, query/mutation actions, Zod validation, response object patterns

### Procedures and Context System
**File:** `.cursor/rules/igniter-procedures.mdc`  
**When to read:** When implementing middleware or extending request context  
**Why:** Guide for dependency injection and reusable middleware creation  
**Key areas:** Context system, procedure creation, type-safe context extension, authentication patterns
