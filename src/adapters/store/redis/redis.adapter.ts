...
import type { EventCallback, KeyValueOptions, IgniterStoreAdapter } from "../../../types/store.interface";
 ...
 */
export function createRedisStoreAdapter(redisClient: Redis): IgniterStoreAdapter {
